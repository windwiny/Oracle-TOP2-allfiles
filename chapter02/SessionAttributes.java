...
---------------------------------------------------------------------------
11.08.2013 Removed static references to class name
29.06.2017 Added code related to the getEndToEndMetrics method
**************************************************************************/
...
public class SessionAttributes
{
  ...
  private static void test() throws Exception
  {
    ...
    System.out.println();
    previousMetrics = ((OracleConnection)connection).getEndToEndMetrics();
    ...
    ((OracleConnection)connection).setEndToEndMetrics(previousMetrics, (short)0);
    getSessionId(); // db call to send the information to the server
    System.out.println("Check V$SESSION, press RETURN to continue...");
    System.in.read(buffer);
  }
