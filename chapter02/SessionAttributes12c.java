...
---------------------------------------------------------------------------
29.06.2017 Added code related to the getClientInfo method
**************************************************************************/
...
public class SessionAttributes12c
{
  ...
  private static void test() throws Exception
  {
    ...
    String previousClientId, previousModule, previousAction;
    ...
    System.out.println("Get initial session information");
    System.out.println();
    previousClientId = connection.getClientInfo("OCSID.CLIENTID");
    previousModule = connection.getClientInfo("OCSID.MODULE");
    previousAction = connection.getClientInfo("OCSID.ACTION");
...
//    connection.setClientInfo("OCSID.SEQUENCE_NUMBER", "42");
    ...
    System.out.println("Reset session information");
    connection.setClientInfo("OCSID.CLIENTID", previousClientId);
    connection.setClientInfo("OCSID.MODULE", previousModule);
    connection.setClientInfo("OCSID.ACTION", previousAction);
    getSessionId(); // db call to send the information to the server
    System.out.println("Check V$SESSION, press RETURN to continue...");
    System.in.read(buffer);
  }
